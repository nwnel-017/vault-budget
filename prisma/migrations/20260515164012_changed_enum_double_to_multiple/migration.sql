/*
  ...
  - The values [MULTIPLE] on the enum `AmountMappingMode` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "AmountMappingMode_new" AS ENUM ('SINGLE', 'SPLIT');
